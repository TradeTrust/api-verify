export const tamperedDocument = {
  ...
  signature: {
    type: "SHA3Merk1eProof",
    targetHash: "b5f493626197f19e9064938ae3a669aaa9a6f10acdeb299ab41e8db7a46035ab",
    proof: [],
    merkleRoot: "b5f493626197f19e9064938ae3a669aaa9a6f10acdeb299ab41e8db7a460359b"
  }
};

export const tamperedResponse = {
  summary: {
    all: false,
    documentStatus: true,
